...
rem start /wait cmd /C copy /Y  now_playing.html   %html-location%\NowPlaying.html
rem start /wait cmd /C copy /Y  latest_five.html   %html-location%\LatestFive.html
rem start /wait cmd /C copy /Y  recent_songs.html  %html-location%\RecentSongs.html
