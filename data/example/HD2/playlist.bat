...
rem start /wait cmd /C copy /Y  now_playing.html   %html-location%\NowPlayingHD2.html
rem start /wait cmd /C copy /Y  latest_five.html   %html-location%\LatestFiveHD2.html
rem start /wait cmd /C copy /Y  recent_songs.html  %html-location%\RecentSongsHD2.html
